      ...
      <div className='max-width  py-[2em]'>
            <div className='flex justify-between items-center '>
                ...
                <div className='hero1 items-end '>
                    <div className='rounded-2xl bg-gradient-to-t from-[#e4a8af]  z-1  h-full w-full opacity-75'></div>
